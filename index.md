...
<div style="display: flex; gap: 40%; align-items: flex-end;">
  <div style="flex: 1.2">
    <a href="https://www.pnnl.gov/">
      <img src="assets/img/PNNL-logo.svg">
    </a>
  </div>
  <div style="flex: 0.7">
    <a href="https://www.energy.gov/">
      <img src="assets/img/DOE-logo.svg">
    </a>
  </div>
</div>
...
<h1>
  <img src="/assets/img/raft_logo_header.jpg" alt="The Risk Analysis Framework for Tropical Cyclones">
</h1>
...
![Sample of RAFT storms in all global basins, which appears visually similar to the frequency and intensity of historically observed storms](/assets/img/ERA5_randomly_sampled_track_intensities_5000.png)
...
![An animation of RAFT genesis locations by date in the Eastern Pacific](/assets/img/synthetic_genesis_samples_trimmed.gif)
...
![Accumulated rainfall from two strong landfalling RAFT storms, in some places exceeding 300 mm](/assets/img/rainfall.png)
...
![A map of projected future changes in storm surge height along the U.S. east and gulf costs. Most areas, particularly the gulf coast and west coast of Florida, see increases](/assets/img/storm_surge.jpg)
...
![U.S. hurricane-induced power outage risk maps in the historical and projected future. Future outages are noticeably more intense](/assets/img/outages.jpg)
...
![Hurricane wind return period maps for the U.S. gulf and east coasts. 100-year return periods exceed Category 4 for much of the gulf coast and Florida](/assets/img/wind_return_periods.jpg)
...
Reproductions of 618 historical storms, and simulations of their behavior in possible future environments with RAFT:

> Lalo, N., Xu, W., Yao, L., Sun, N., Balaguru, K., Rice, J., Thurber, T., Yang, Z., Deb, M., & Judi, D. (2025). Future North Atlantic tropical cyclone intensities in modified historical environments (Version v2) [Data set]. MSD-LIVE Data Repository. https://doi.org/10.57931/2588708
